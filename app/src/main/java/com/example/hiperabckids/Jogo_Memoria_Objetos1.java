...
public class Jogo_Memoria_Objetos1 extends AppCompatActivity {


    private int[] cardImages = {
            R.drawable.bola_praia, R.drawable.bola_praia,
            R.drawable.pincel, R.drawable.pincel,
            R.drawable.cavalo_pau, R.drawable.cavalo_pau,
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jogo_memoria_objetos1);
    ...
    private void flipCard(ImageView imageView, int index) {
        ...
        if (previousCard == -1) {
            ...
            if (cardImages[previousCard] == cardImages[index]) { // Verifica o par
                if (cardImages[index] == R.drawable.bola_praia) {
                    playSound(R.raw.bola_som);
                } else if (cardImages[index] == R.drawable.pincel) {
                    playSound(R.raw.pincel_som);
                } else if (cardImages[index] == R.drawable.cavalo_pau) {
                    playSound(R.raw.cavalinho_som);
                }
    ...
    private void goToNextActivity() {
        Intent intent = new Intent(this, Jogo_Memoria_Objetos2.class); // Substitua NextActivity pela sua próxima atividade
