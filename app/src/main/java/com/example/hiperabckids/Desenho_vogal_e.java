...
public class Desenho_vogal_e extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_desenho_vogal_e);

        constraintLayout = findViewById(R.id.main);

        // Inicializar o mapeamento de botões para arquivos de áudio
        buttonSoundMap = new HashMap<>();
        ImageButton button = findViewById(R.id.imgbutt1_a);
        ImageButton button2 = findViewById(R.id.imgbutt3_a);
        if (button != null) {
            buttonSoundMap.put(button, R.raw.audio_elefante);
        }
        if(button2 != null){
            buttonSoundMap.put(button2, R.raw.audio_estrela);
        }

        // Inicializar o MediaPlayer para reprodução automática
        mediaPlayerAuto = MediaPlayer.create(this, R.raw.audio_instrucao_e);
        ...
        for (Map.Entry<ImageButton, Integer> entry : buttonSoundMap.entrySet()) {
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    MediaPlayer mediaPlayer = MediaPlayer.create(Desenho_vogal_e.this, soundID);
                    if (mediaPlayer != null) {
                        mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                            ...
                            public void onCompletion(MediaPlayer mp) {
                                ...
                                if (soundID == R.raw.audio_elefante) {
                                    button1AudioFinished = true;
                                } else if (soundID == R.raw.audio_estrela) {
    ...
    private void goToFinalActivity() {
        Intent intent = new Intent(Desenho_vogal_e.this, Desenho_vogal_i.class); // Altere para sua próxima atividade
    ...
    private void showDialogWithAnimation1() {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(Desenho_vogal_e.this, R.style.CombinacaoDialog);
                View dialogView = getLayoutInflater().inflate(R.layout.comemoracao1_e, null);
                ...
                MediaPlayer md = MediaPlayer.create(Desenho_vogal_e.this, R.raw.audio1_parabens_e);
                md.start();
    ...
    private void showDialogWithAnimation2() {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                View main = findViewById(R.id.main);
                AlertDialog.Builder builder = new AlertDialog.Builder(Desenho_vogal_e.this, R.style.CombinacaoDialog);
                View dialogView = getLayoutInflater().inflate(R.layout.comemoracao2_e, null);
                ...
                MediaPlayer md = MediaPlayer.create(Desenho_vogal_e.this, R.raw.audio2_parabens_e);
                md.start();
    ...
    public void Voltar_menu(View view) {
        Intent in = new Intent(Desenho_vogal_e.this, Tela_menu.class);
        startActivity(in);
    }
}
