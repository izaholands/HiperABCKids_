...
public class Jogo_Memoria_Objetos3 extends AppCompatActivity {


    private int[] cardImages = {
            R.drawable.sol, R.drawable.sol,
            R.drawable.oculos_sol, R.drawable.oculos_sol,
            R.drawable.nuvem, R.drawable.nuvem,
            R.drawable.flor, R.drawable.flor,
            R.drawable.balao, R.drawable.balao,
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jogo_memoria_objetos3);
    ...
    private void flipCard(ImageView imageView, int index) {
        ...
        if (previousCard == -1) {
            ...
            if (cardImages[previousCard] == cardImages[index]) { // Verifica o par
                if (cardImages[index] == R.drawable.sol) {
                    playSound(R.raw.sol_som);
                } else if (cardImages[index] == R.drawable.oculos_sol) {
                    playSound(R.raw.oculos_de_sol_som);
                } else if (cardImages[index] == R.drawable.nuvem) {
                    playSound(R.raw.nuvem_som);
                } else if (cardImages[index] == R.drawable.flor) {
                    playSound(R.raw.flor_som);
                } else if (cardImages[index] == R.drawable.balao) {
                    playSound(R.raw.balao_som);
                }
    ...
    private void goToNextActivity() {
        Intent intent = new Intent(this, Jogo_Memoria_Transporte.class); // Substitua NextActivity pela sua próxima atividade
