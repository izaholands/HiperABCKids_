...
public class Jogo_Memoria_Animais1 extends AppCompatActivity {


    private int[] cardImages = {
            R.drawable.cao, R.drawable.cao,
            R.drawable.vaca, R.drawable.vaca,
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jogo_memoria_animais1);
        EmbaralhaCartas();
    ...
    private void flipCard(ImageView imageView, int index) {
        ...
        if (previousCard == -1) {
            ...
            if (cardImages[previousCard] == cardImages[index]) { // Verifica o par
                if (cardImages[index] == R.drawable.cao) {
                    playSound(R.raw.cachorro_som);
                } else if (cardImages[index] == R.drawable.vaca) {
                    playSound(R.raw.vaca_som);
                }
    ...
    private void goToNextActivity() {
        Intent intent = new Intent(this, Jogo_Memoria_Animais2.class); // Substitua NextActivity pela sua próxima atividade
