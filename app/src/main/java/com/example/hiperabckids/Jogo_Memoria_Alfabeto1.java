...
public class Jogo_Memoria_Alfabeto1 extends AppCompatActivity {


    private int[] cardImages = {
            R.drawable.letra_a1, R.drawable.letra_a1,
            R.drawable.letra_b, R.drawable.letra_b,
            R.drawable.letra_c, R.drawable.letra_c,
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jogo_memoria_alfabeto1);
    ...
    private void flipCard(ImageView imageView, int index) {
        ...
        if (previousCard == -1) {
            ...
            if (cardImages[previousCard] == cardImages[index]) { // Verifica o par
                ...
                } else if (cardImages[index] == R.drawable.letra_b) {
                    playSound(R.raw.b_jogomemoria);
                } else if (cardImages[index] == R.drawable.letra_c) {
                    playSound(R.raw.c_jogomemoria);
                }
    ...
    private void goToNextActivity() {
        Intent intent = new Intent(this, Jogo_Memoria_Alfabeto2.class); // Substitua NextActivity pela sua próxima atividade
